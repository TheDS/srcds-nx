...
{
	int64_t diff = int64_t(target) - int64_t(codegen.GetData()) + codegen.get_outputpos() + OP_JMP_SIZE;
...
bool CDetour::CreateDetour()
{
	...
	codegen.set_outputpos(detour_restore.bytes);
