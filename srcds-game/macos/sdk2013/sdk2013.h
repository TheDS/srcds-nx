...
#ifndef _INCLUDE_SRCDS_SDK2013_H_
#define _INCLUDE_SRCDS_SDK2013_H_

#include "IServerFixer.h"

class SDK2013 : public IServerFixer
{
public:
	...
	static inline SDK2013 &GetInstance() {
		static SDK2013 fixer;
		return fixer;
	}
};

#endif // _INCLUDE_SRCDS_SDK2013_H_
