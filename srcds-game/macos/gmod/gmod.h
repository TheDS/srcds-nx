...
#ifndef _INCLUDE_SRCDS_GMOD_H_
#define _INCLUDE_SRCDS_GMOD_H_

#include "IServerFixer.h"

class GarrysMod : public IServerFixer
{
public:
	...
	static inline GarrysMod &GetInstance() {
		static GarrysMod fixer;
		return fixer;
	}
private:
