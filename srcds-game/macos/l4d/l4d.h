...
#ifndef _INCLUDE_SRCDS_LEFT4DEAD_H_
#define _INCLUDE_SRCDS_LEFT4DEAD_H_

#include "IServerFixer.h"

class Left4Dead : public IServerFixer
{
public:
	...
	static inline Left4Dead &GetInstance() {
		static Left4Dead fixer;
		return fixer;
	}
	static const char *FixLibraryExt(const char *pModuleName, char *buffer, size_t maxLength);
	static bool BuildCmdLine();
private:
...
#endif // _INCLUDE_SRCDS_LEFT4DEAD_H_
