...
#ifndef _INCLUDE_SRCDS_LEFT4DEAD2_H_
#define _INCLUDE_SRCDS_LEFT4DEAD2_H_

#include "IServerFixer.h"

class Left4Dead2 : public IServerFixer
{
public:
	...
	static inline Left4Dead2 &GetInstance() {
		static Left4Dead2 fixer;
		return fixer;
	}
private:
...
#endif // _INCLUDE_SRCDS_LEFT4DEAD2_H_
